            ...
            Row {
                ...
                Column(
                    ...
                    Spacer(modifier = Modifier.height(10.dp))
                        ...
                        Text(
                            text = "This application desiged as a project that represented to Bharath Institute of higher Education",
                            fontSize = 16.sp,
                            fontWeight = FontWeight.Normal,
                            ...
                            onClick = {
                                ...
                                context.startActivity(
                                    Intent.createChooser(
                                        shareIntent,
                                        "Designed by Yuva Simha Reddy"
                                    )
                                )
                            }
                        ) {
                            Text(
                                text = "Designed by Yuva Simha Reddy",
                                fontSize = 18.sp,
                                fontWeight = FontWeight.Black,
                                style = MaterialTheme.typography.bodyLarge
                            )
